...
Private Sub Form_Load()
  ...
  llenarlst lstclientes, "select * from clientes where regvalid", Array("nom_cli"), "cod_cli"
  llenarlst lstclientes1, "select * from clientes where regvalid", Array("nom_cli"), "cod_cli"
